package dev.risenid.tessera.protocol

import android.content.Context
import android.util.Log
import dev.risenid.tessera.Bus
import dev.risenid.tessera.Pairing
import dev.risenid.tessera.TesseraService
import dev.risenid.tessera.Store
import dev.risenid.tessera.features.Agenda
import dev.risenid.tessera.features.AppNames
import dev.risenid.tessera.features.AppsRepository
import dev.risenid.tessera.features.AudioStreamer
import dev.risenid.tessera.features.Beacon
import dev.risenid.tessera.features.Contacts
import dev.risenid.tessera.features.FileTransfer
import dev.risenid.tessera.features.StorageServer
import dev.risenid.tessera.features.Wallpaper
import dev.risenid.tessera.features.WifiShare
import dev.risenid.tessera.features.CameraStreamer
import dev.risenid.tessera.features.CallMonitor
import dev.risenid.tessera.features.CallsRepository
import dev.risenid.tessera.features.Capabilities
import dev.risenid.tessera.features.ClipboardBridge
import dev.risenid.tessera.features.ClipboardWatcher
import dev.risenid.tessera.features.DesktopMessages
import dev.risenid.tessera.features.DndController
import dev.risenid.tessera.features.FindPhone
import dev.risenid.tessera.features.Handoff
import dev.risenid.tessera.features.Hotspot
import dev.risenid.tessera.features.MediaRepository
import dev.risenid.tessera.features.MicStreamer
import dev.risenid.tessera.features.NetworkAddresses
import dev.risenid.tessera.features.NotificationBridge
import dev.risenid.tessera.features.NowPlaying
import dev.risenid.tessera.features.PhoneStatus
import dev.risenid.tessera.features.PrivilegedShell
import dev.risenid.tessera.features.ProjectionGrant
import dev.risenid.tessera.features.TetheringController
import dev.risenid.tessera.features.SmsRepository
import dev.risenid.tessera.features.StillCapture
import dev.risenid.tessera.features.TextInput
...
class Session(
    ...
    private fun subscribe(requested: org.json.JSONArray?) {
        ...
        dev.risenid.tessera.features.SensitiveNotifications.ensure(context)
