...
import dev.risenid.tessera.net.Advertiser
import dev.risenid.tessera.net.TlsServer
import dev.risenid.tessera.protocol.Session
...
class TesseraService : Service() {
    ...
    override fun onDestroy() {
        ...
        sessions.clear()
        dev.risenid.tessera.features.StorageServer.stop()
        tls.stop()
        workers.shutdownNow()
    ...
    companion object {
        ...
        const val ACTION_STOP = "dev.risenid.tessera.STOP"
